...
<html>
  ...
  <body>
    <div class="Loginbox">
      <h3 style="float:left;">Tulis Artikel</h3><br>
      <h1 style="float:right;"> <a href="konten.php" style="font-size:25pt;">X</a></h1>
      <form class="" action="" method="post">
        ...
        <button type="submit" name="submit">Kirim Berita</button><br><br>
      </form>
